...
class QMemoryWidget(QTableWidget):
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_G:
            ...
            super(QMemoryWidget, self).keyPressEvent(event)
    ...
    def get_source_type(self):
        """
        implement in widget implementation.
        :return: the source from which Range should read data.
                check Range class for available sources
        """
        pass
