...
def main():
    ...
    if args.java is None and args.native is None:
    ...
    if args.java is not None:
        ...
        ''' % ('.'.join(fmt_args))
    elif args.native is not None:
        target_address_str = str(args.native)
        ...
        native_registers = ''
        if args.native_registers is not None:
            native_registers += args.native_registers
