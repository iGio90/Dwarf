    ...
    function _DwarfApi() {
        ...
        this.restart = function() {
            Java.perform(function () {
                ...
                if (getDwarf().javaAppContext === null) {
                    var ActivityThread = Java.use('android.app.ActivityThread');
                    var Context = Java.use('android.content.Context');
                    getDwarf().javaAppContext = Java.cast(ActivityThread.currentApplication().getApplicationContext(), Context);
                }
...
rpc.exports = {
    ...
    apilist: function () {
        return {
            'Dwarf': Object.keys(api),
            'DebugSymbol': Object.keys(DebugSymbol),
            'Frida': Object.keys(Frida),
            'Instruction': Object.keys(Instruction),
            'Interceptor': Object.keys(Interceptor),
            'Java': Object.keys(Java),
            'Kernel': Object.keys(Kernel),
            'Memory': Object.keys(Memory),
            'MemoryAccessMonitor': Object.keys(MemoryAccessMonitor),
            'Module': Object.keys(Module),
            'ModuleMap': Object.keys(ModuleMap),
            'ObjC': Object.keys(ObjC),
            'Process': Object.keys(Process),
            'Stalker': Object.keys(Stalker),
            'Thread': Object.keys(Thread),
        };
    }
};
...
var InterceptorWrapper = function() {
    this.attach = function (pt, logic) {
        try {
            ...
            hook.interceptor = wrappedInterceptor.attach(hook.nativePtr, function () {
